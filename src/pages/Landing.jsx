import { ArrowRight, BookOpen, Check, ChevronRight, Gamepad2, MessageSquare, Sparkles, UserCheck, Zap } from 'lucide-react';
...
export default function Landing({ onEnterApp }) {
  return (
    <div className="nlr-landing">
      ...
      <main>
        <section className="nlr-hero nlr-wrap" id="atas"><div className="nlr-hero__copy"><span className="nlr-hero__eyebrow"><Sparkles size={15} /> LMS ringan untuk kelas yang lebih aktif</span><h1>Belajar, bermain,<br /><em>dan tumbuh.</em></h1><p>Nalaro menyatukan materi, diskusi, kuis interaktif, dan presensi dalam satu ruang kelas digital. Ringan dipakai, mudah diatur.</p><div className="nlr-hero__actions"><button type="button" className="nlr-action nlr-action--primary" onClick={onEnterApp}>Mulai sekarang <ArrowRight size={18} /></button><a className="nlr-action nlr-action--text" href="#platform">Lihat cara kerjanya <ArrowRight size={18} /></a></div><div className="nlr-hero__proof"><span><Check size={15} /> Tanpa instalasi</span><span><Zap size={15} /> Kuis live & mandiri</span><span><UserCheck size={15} /> Guru + siswa</span></div></div><div className="nlr-hero__preview"><div className="nlr-hero__halo" aria-hidden="true" /><ProductPreview /><div className="nlr-hero__float nlr-hero__float--top"><Sparkles size={15} /><span><b>Lebih terarah</b><small>Materi sampai evaluasi</small></span></div><div className="nlr-hero__float nlr-hero__float--bottom"><Gamepad2 size={15} /><span><b>Lebih aktif</b><small>Belajar sambil mencoba</small></span></div></div></section>
